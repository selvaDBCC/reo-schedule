...
async function doPdfExtract(file){
  ...
  // Accepts "Square Mesh", "Rectangular Mesh", "Reinforcing Mesh" in description.
  // The SL|RL prefix on the code keeps this distinct from trench mesh (which uses TM).
  ...
  // Handles L8/L11/L12/L16 prefixes and optional "W" suffix (e.g. L16TM3W).
  // Bar diameter in description is optional — some PDFs may omit it.
